    ...
    <div class="relative w-full h-full flex items-center justify-center" style="background-image: url('./Assets/Imgs/Sands.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="relative z-10 w-full flex flex-col items-center justify-center px-4">
            ...
            <div class="w-full max-w-md">
                ...
                <form class="space-y-6" method="POST" action="./Process/Authentication.php">
                    <!-- Username Field -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" placeholder="••••••••••••" class="w-full px-4 py-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-[#3369FF] focus:border-transparent bg-white/80">
                    </div>
                    ...
                    <!-- Sign In Button -->
                    <button type="submit" name="signinBtn" class="w-full bg-[#395B64] hover:bg-[#2F4D55] text-white font-semibold py-3 px-4 rounded-md transition-colors cursor-pointer">
                        Sign in
                    </button>
